...
urlpatterns = [
    ...
    path('<int:pk>/reviews-create/', ReviewCreateView.as_view(), name='review-create'),  # Create review for a specific watchlist item
    path('<int:pk>/reviews/', ReviewListView.as_view(), name='review-list'),             # List all reviews for a specific watchlist item
